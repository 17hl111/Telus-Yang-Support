...
const https = __importStar(__webpack_require__(10));
const diagnostics_1 = __webpack_require__(44);
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.connectGitLab', () => {
        const panel = vscode.window.createWebviewPanel('gitLabConnection', 'Connect to GitLab', vscode.ViewColumn.One, {
            enableScripts: true
        });
        // 设置Webview内容
        ...
        // 创建一个 Webview 面板
        const panel = vscode.window.createWebviewPanel('triggerPipeline', 'Trigger Pipeline', vscode.ViewColumn.One, {
            ...
            if (message.command === 'triggerPipeline') {
                try {
                    ...
                    if (fileUri && fileUri.length > 0) {
                        ...
                        // 发送请求触发流水线
                        const response = await axios_1.default.post(pipeurl, postdata, {
                            headers: {
                        ...
                        if (response.status === 201 || response.status === 200) {
                            ...
                            const pipelinesResponse = await axios_1.default.get(pipelinesUrl, {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.yangQuickValidation', () => {
        ...
        if (editor) {
            ...
            (0, child_process_1.exec)(`pyang ${filePath}`, (error, stdout, stderr) => {
                if (error) {
...
// 连接到 GitLab 的函数
async function connectToGitLab(gitLabUrl, privateToken, pathToCert) {
...
const zlib = __webpack_require__(41);
const stream = __webpack_require__(6);
const events = __webpack_require__(42);
...
/* harmony export */ });
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(40);
